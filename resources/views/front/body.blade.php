        ...
        <div class="box">
            ...
            <ul class="portfolio-items col-4">
                <li class="portfolio-item apps">
                    <div class="item-inner">
                        <div class="portfolio-image">
                            <img src="{{ asset('assets/app/images/portfolio/thumb/item1.jpg') }}" alt="">
                            <div class="overlay">
                                <a class="preview btn btn-danger" title="Lorem ipsum dolor sit amet" href="{{ asset('assets/app/images/portfolio/full/item1.jpg') }}"><i class="icon-eye-open"></i></a>
                            </div>
                        </div>
                ...
                <li class="portfolio-item joomla bootstrap">
                    <div class="item-inner">
                        <div class="portfolio-image">
                            <img src="{{ asset('assets/app/images/portfolio/thumb/item2.jpg') }}" alt="">
                            <div class="overlay">
                                <a class="preview btn btn-danger" title="Lorem ipsum dolor sit amet" href="{{ asset('assets/app/images/portfolio/full/item2.jpg') }}"><i class="icon-eye-open"></i></a>
                            </div>
                        </div>
                        <h5>Lorem ipsum dolor sit amet</h5>
                    </div>
                ...
                <li class="portfolio-item bootstrap wordpress">
                    <div class="item-inner">
                        <div class="portfolio-image">
                            <img src="{{ asset('assets/app/images/portfolio/thumb/item3.jpg') }}" alt="">
                            <div class="overlay">
                                <a class="preview btn btn-danger" title="Lorem ipsum dolor sit amet" href="{{ asset('assets/app/images/portfolio/full/item3.jpg') }}"><i class="icon-eye-open"></i></a>
                            </div>
                        </div>
                        <h5>Lorem ipsum dolor sit amet</h5>
                    </div>
                ...
                <li class="portfolio-item joomla wordpress apps">
                    <div class="item-inner">
                        <div class="portfolio-image">
                            <img src="{{ asset('assets/app/images/portfolio/thumb/item4.jpg') }}" alt="">
                            <div class="overlay">
                                <a class="preview btn btn-danger" title="Lorem ipsum dolor sit amet" href="{{ asset('assets/app/images/portfolio/full/item4.jpg') }}"><i class="icon-eye-open"></i></a>
                            </div>
                        </div>
                        <h5>Lorem ipsum dolor sit amet</h5>
                    </div>
                ...
                <li class="portfolio-item joomla html">
                    <div class="item-inner">
                        <div class="portfolio-image">
                            <img src="{{ asset('assets/app/images/portfolio/thumb/item5.jpg') }}" alt="">
                            <div class="overlay">
                                <a class="preview btn btn-danger" title="Lorem ipsum dolor sit amet" href="{{ asset('assets/app/images/portfolio/full/item5.jpg') }}"><i class="icon-eye-open"></i></a>
                            </div>
                        </div>
                        <h5>Lorem ipsum dolor sit amet</h5>
                    </div>
                ...
                <li class="portfolio-item wordpress html">
                    <div class="item-inner">
                        <div class="portfolio-image">
                            <img src="{{ asset('assets/app/images/portfolio/thumb/item6.jpg') }}" alt="">
                            <div class="overlay">
                                <a class="preview btn btn-danger" title="Lorem ipsum dolor sit amet" href="{{ asset('assets/app/images/portfolio/full/item6.jpg') }}"><i class="icon-eye-open"></i></a>
                            </div>
                        </div>
                        <h5>Lorem ipsum dolor sit amet</h5>
                    </div>
                ...
                <div class="carousel-inner">
                    <div class="item active">
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="member">
                                    <p><img class="img-responsive img-thumbnail img-circle" src="{{ asset('assets/app/images/team1.jpg') }}" alt="" ></p>
                                    <h3>Agnes Smith<small class="designation">CEO &amp; Founder</small></h3>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="member">
                                    <p><img class="img-responsive img-thumbnail img-circle" src="{{ asset('assets/app/images/team2.jpg') }}" alt="" ></p>
                                    <h3>Donald Ford<small class="designation">Senior Vice President</small></h3>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="member">
                                    <p><img class="img-responsive img-thumbnail img-circle" src="{{ asset('assets/app/images/team3.jpg') }}" alt="" ></p>
